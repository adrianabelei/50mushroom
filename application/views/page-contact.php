...
<body>
    ...
    <div class="row"><!--Container row-->
        ...
        <div class="span4 sidebar page-sidebar"><!-- Begin sidebar column -->
            ...
            <address>
            <strong>Postal and Visiting Address</strong><br>
            Stationsplein 45, A4.004<br>
            3013 AK, Rotterdam<br>
            4th floor of Groot Handelsgebouw<br>
            <abbr title="Phone">P:</abbr> (123) 456-7890
            </address>
             
            <address>
            <strong>General questions</strong><br>
            <a href="mailto:#">Team@VentureCafeRotterdam.org</a><br><br>
            <strong>Contribute to our Community News</strong><br>
            <a href="mailto:#">News@VentureCafeRotterdam.org</a>
            </address>
