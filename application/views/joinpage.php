...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXcm" crossorigin="anonymous">
...
<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
    ...
    <link rel="stylesheet" href="assets/css/stylejoinpage.css">
</head>
...
<body>
    ...
    <?php if(isset($errors)){
      ...
      <form id="signup" method="post" action="register">
        ...
        <input name="confirmPassword" type="password" placeholder="Confirm password" class="input pass"/>
